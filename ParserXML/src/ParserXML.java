...
//    }
    ...
    public static void createBody2(File file, String outputName) {
        ...
        try {
            ...
            BufferedWriter out = new BufferedWriter(new FileWriter("parsed_files/" + outputName + "_part0.txt"));
            String line;
            String tag = "";
            String cont = "";
            int counter = 0;
...
//                        indexerRow = new String[4];
                        ...
                        if (lineNumber >= 1000) {
                            ...
                            out.close();
                            filename = outputName + "_part" + part;
                            out = new BufferedWriter(new FileWriter("parsed_files/" + filename + ".txt"));
                        }
...
//    }
    ...
    public static String replaceInLine(String line) {
        line = line.replaceAll("[ąĄ]", "a");
        line = line.replaceAll("[ęĘ]", "e");
        line = line.replaceAll("[śŚ]", "s");
        line = line.replaceAll("[ćĆ]", "c");
        line = line.replaceAll("[żŻ]", "z");
        line = line.replaceAll("[źŹ]", "z");
        line = line.replaceAll("[ńŃ]", "n");
        line = line.replaceAll("[łŁ]", "l");
        line = line.replaceAll("[óÓ]", "o");
